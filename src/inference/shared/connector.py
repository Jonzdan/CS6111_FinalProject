...
class P2pConnector(KVConnectorBase_V1):
    def __init__(self, vllm_config: "VllmConfig", role: KVConnectorRole):
        ...
        self.p2p_engine = (
            P2pEngine(
                ...
                config=self._vllm_config.kv_transfer_config,
                hostname="localhost",
    ...
    def start_load_kv(self, forward_context: "ForwardContext", **kwargs: Any) -> None:
        ...
        assert self.p2p_engine is not None
        ...
        assert isinstance(metadata, P2pConnectorMetadata)
        ...
        for request in metadata.requests:
            ...
            for layer_name in forward_context.no_compile_layers:
                ...
                kv_cache = self.p2p_engine.recv_tensor(
    ...
    def save_kv_layer(
        ...
        **kwargs: Any,
        ...
        assert isinstance(connector_metadata, P2pConnectorMetadata)
    ...
    def get_finished(
        ...
        return self.p2p_engine.get_finished(finished_req_ids, no_compile_layers)
